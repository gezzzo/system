...
<body onload="document.form1.text1.focus()">
    <article class="auth">
        ...
        <form action="registerstudent.php" method="post"  name="form1">
                ...
                <input type="email" name="text1" class="form-control" placeholder="الايميل" />
                ...
                <button type="submit" onclick="ValidateEmail(document.form1.text1)" name="submit" class="btn">تسجيل</button>
